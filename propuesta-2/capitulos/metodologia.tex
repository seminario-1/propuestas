...
Intuitivamente, se espera que las imágenes de mayor tamaño tomen más tiempo en ser redimensionadas y que lo contrario suceda con las imágenes de menor tamaño. Los resultados obtenidos brindarán una referencia para saber cómo es que los componentes de software asociados al redimiensiomiendo de la imagen trabajan y qué posibles mejoras podrían realizarse. 
...
\begin{itemize}
    \item Una carga de trabajo cerrada de una solicitud de redimensionamiento que se repetirá durante 30 minutos. 
\end{itemize}
...
\paragraph{Variar intervalo entre lanzamientos de actividad hacia los servidores}
