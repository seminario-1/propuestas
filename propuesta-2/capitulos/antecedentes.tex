...
\begin{figure}[h]
  \centering
  \includegraphics[width=15cm]{Kate-Service-layers-IaaS_PaaS_SaaS}
...
\paragraph{Posicionamiento de la investigación con respecto a la literatura consultada}
